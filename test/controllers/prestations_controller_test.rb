...
class PrestationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestation" do
    assert_difference('Prestation.count') do
      post prestations_url, params: { prestation: { length: @prestation.length, name: @prestation.name, prestationtype_id: @prestation.prestationtype_id, prestationtypecolumn: @prestation.prestationtypecolumn, price: @prestation.price } }
    end
  ...
  test "should update prestation" do
    patch prestation_url(@prestation), params: { prestation: { length: @prestation.length, name: @prestation.name, prestationtype_id: @prestation.prestationtype_id, prestationtypecolumn: @prestation.prestationtypecolumn, price: @prestation.price } }
