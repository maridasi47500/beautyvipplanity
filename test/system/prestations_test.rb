...
class PrestationsTest < ApplicationSystemTestCase
  ...
  test "creating a Prestation" do
    ...
    fill_in "Length", with: @prestation.length
    fill_in "Name", with: @prestation.name
    fill_in "Prestationtype", with: @prestation.prestationtype_id
    fill_in "Prestationtypecolumn", with: @prestation.prestationtypecolumn
